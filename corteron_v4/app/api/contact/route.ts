    ...
    await resend.emails.send({
      ...
      html: `
        <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#050510;border-radius:12px;overflow:hidden;">
          <div style="background:#0D0D1F;padding:24px 32px;border-bottom:1px solid rgba(79,70,229,0.3);">
            <h1 style="color:#4F46E5;margin:0;font-size:20px;letter-spacing:4px;font-weight:700;">CORTERON</h1>
          ...
          <div style="padding:28px 32px;">
            <table style="width:100%;border-collapse:collapse;">
              ...
              <tr><td style="color:#6B7280;padding:10px 0;font-size:13px;border-bottom:1px solid rgba(255,255,255,0.05);">Email</td><td style="padding:10px 0;font-size:14px;border-bottom:1px solid rgba(255,255,255,0.05);"><a href="mailto:${email}" style="color:#4F46E5;text-decoration:none;">${email}</a></td></tr>
            ...
            <div style="margin-top:20px;padding:14px 16px;background:rgba(79,70,229,0.08);border-radius:8px;border:1px solid rgba(79,70,229,0.2);">
      ...
      html: `
        <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#050510;border-radius:12px;overflow:hidden;">
          ...
          <div style="padding:32px;">
            ...
            <p style="color:#6B7280;font-size:13px;margin:0;">Corteron - <a href="https://corteron.com" style="color:#4F46E5;text-decoration:none;">corteron.com</a></p>
          </div>
        </div>`,
    })
